...
class imagenesRoutes {
    ...
    config() {
        ...
        this.router.post('/addImagen/', ImagenesController_1.imagenesController.addImagen);
        ...
        this.router.put('/actualizarImagen/:id', ImagenesController_1.imagenesController.actualizarImagen);
    }
}
